export default [
  {
    id: 1,
    content: "<h3>How do I get Docker working?</h3><p>I can't seem to get Docker to run, any ideas?</p>",
    user_id: 1,
    comments:
      [
        {
  ...
  {
    id: 5,
    content: "<h3>Lorem ipsum.</h3><p>Mauris tortor eros, interdum at massa vitae, eleifend consequat justo. Donec " +
